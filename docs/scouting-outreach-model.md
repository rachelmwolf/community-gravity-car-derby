# Scouting Outreach Model

## Purpose

This document captures how the event can welcome interest from other Cub Scout packs without turning the derby into a scouting-heavy room that displaces families, racers, or the broader community audience.

## Core Goal

The event should stay community-facing first, while still making sure that any family interested in scouting has a simple, visible next step.

That means:

- the event should not feel like a pack recruiting fair
- scouting should be available as a resource, not the dominant identity of the room
- interested families should be able to connect with a real pack representative before they leave

## Recommended Outreach Stance

Use a `resource table` model, not a `full pack presence` model.
...
## Room-Balance Principle

The room should be filled primarily by:
...
Additional scouting adults should only be present when they are:

- staffing a clear resource role
...
Use one shared scouting resource point instead of multiple competing pack tables.
...
## Best Moments For Scouting Contact

The most natural times for scouting contact are:

- before opening while families are arriving
- between race blocks if there is dead time
- after awards as families linger or ask questions

The least helpful times are:
...
If this is handled well, families leave with:

- a good race experience
- a clear positive impression of scouting
- a next step if they want one

If this is handled poorly, families may feel like they attended a recruiting event instead of a derby.