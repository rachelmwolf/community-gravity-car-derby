...
`Wheelbase extensions are allowed. Cars must still fit the track, the starting pin, and all published clearance requirements.`
...
`Cars must use the standard wheels and axles provided in the kit or committee-approved replacements of the same type. Bearings, bushings, washers, and performance replacement wheels are not permitted.`
...
- do not add inspection items volunteers cannot measure quickly
- do not keep rules that are hard to explain to first-time families
- do not keep provenance-heavy rules unless they are truly needed for fairness