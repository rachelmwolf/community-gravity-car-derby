# Critical Leads Assignment Sheet

## Purpose

Use this to confirm the minimum lead coverage required to run the event.
...
- Race Director confirmed
- Chief Inspector confirmed
...
Backups should be identified for:

- Race Director
- Chief Inspector
- Safety Lead
- Track Operations Lead

Backups are strongly preferred for:
...
- owns final day-of decisions
- protects schedule and escalation path

### Chief Inspector

- enforces build rules
- resolves pass / fail questions
- determines whether a car needs pit correction or may proceed

### Safety Lead

- owns emergency response path
- confirms first-aid location and hazard checks

### Event Host / MC

- explains what is happening
- supports opening and awards flow

### Track Operations Lead

- runs heats
- works with staging and scoring
